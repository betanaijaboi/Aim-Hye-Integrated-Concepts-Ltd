    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-sm text-slate-500 mb-6">
          <Link href="/" className="hover:text-[#1e3a5f] transition-colors">Store</Link>
          <span aria-hidden="true">/</span>
          <span className="hover:text-[#1e3a5f] transition-colors">{product.brewery.name}</span>
          <span aria-hidden="true">/</span>
          <span aria-current="page" className="font-medium text-[#1e3a5f]">{product.name}</span>
        </nav>
